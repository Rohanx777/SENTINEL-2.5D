# SENTINEL-3D Launch Status Report
...
- **Format**: Modern SENTINEL-3D schema with `grid_data` (polygon objects), `telemetry`, `threats`
...
- Browser console log: `[SENTINEL-3D] WebSocket encountered error: [object Event]`
...
```
file:///C:/Users/Rohan/Desktop/vs code projects/lidar inference/SENTINEL-3D/test_websocket.html
```

@echo off
REM ============================================================
REM  SENTINEL-2.5D Instant 1-Click Launcher (Windows)
REM  DRDO Defense Tactical Perception Platform
REM ============================================================

title SENTINEL-2.5D Tactical Perception Engine
cls

echo ============================================================
echo   SENTINEL-2.5D - Defense Tactical Perception Engine (DRDO)
...
if errorlevel 1 (
    echo.
    echo [!] SENTINEL-2.5D process stopped with error code %errorlevel%.
    pause
)

#!/bin/bash
# ============================================================
#  SENTINEL-2.5D Unified Launcher (Linux/macOS)
#  Starts C++/CUDA backend + Next.js frontend in one command
# ============================================================

echo ""
echo "============================================================"
echo "  SENTINEL-2.5D - Defense Tactical Perception Engine"
...
cleanup() {
    echo ""
    echo "Stopping SENTINEL-2.5D services..."
...
echo ""
echo "============================================================"
echo "  SENTINEL-2.5D is now running!"
echo ""
